              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="cd-trainer-pic">
                    <img
                      src="img/classes/class-details/trainer-profile.jpg"
                      alt=""
                    />
                  </div>
                </div>
        ...
        <div className="col-lg-4 col-md-8">
          <div className="sidebar-option">
            ...
            <div className="so-latest">
              ...
              <div
                className="latest-large set-bg"
                 style={{backgroundImage:`url('img/letest-blog/latest-1.jpg')`}}
            ...
            <div
              ...
              style={{backgroundImage:`url('img/sidebar-banner.jpg')`}}
            >
